...
<tr class="shipping">
    ...
    <?php
    $methods_desc = array(
        'local_pickup' => 'Selecteer hierboven een afhaallocatie',
    );
    ?>
    <?php foreach ( $available_methods as $method ) :  ?>
        <li>
            ...
            <div style="margin-left: 25px;"><small><i><?php if( isset( $methods_desc[ $method->id ] ) ) : ?><p class="desc"><?php echo $methods_desc[ $method->id ]; ?></p><?php endif ?></i></small></div>
        </li>
    <?php endforeach; ?>
	</ul>
